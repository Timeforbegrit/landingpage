...
const faqData: FAQItem[] = [
  {
    ...
    answer: "MVP-версия запускается за 4-6 недель. Полная интеграция со всеми корпоративными системами занимает 2-3 месяца в зависимости от сложности инфраструктуры."
  },
  {
