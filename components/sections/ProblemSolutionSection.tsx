        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="opacity-100">
            <div className="relative h-full">
              <div className="bg-gradient-to-br from-red-900/20 to-red-800/10 border border-red-500/30 rounded-2xl p-8 hover:border-red-500/50 transition-all duration-500 group h-full flex flex-col">
                {/* Header */}
          ...
          <div className="opacity-100">
            <div className="relative h-full">
              {/* Solution Card */}
              <div className="bg-gradient-to-br from-blue-900/20 to-blue-800/10 border border-blue-500/30 rounded-2xl p-8 hover:border-blue-500/50 transition-all duration-500 group h-full flex flex-col">
                {/* Header */}
                <div className="flex items-center gap-4 mb-8">
                  <div className="relative">
