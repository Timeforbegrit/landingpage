...
const targetAudience = [
  {
    ...
    customerJourney: "Я месяцами собирал риски из десятков Excel-файлов и почтовых цепочек. Теперь ИИ за минуты дает мне полную картину — работаю в 6 раз быстрее!"
  },
  {
  ...
  },
  {
    ...
    customerJourney: "Финансовые кризисы всегда застигали врасплох... Бюджеты летели. ИИ-прогнозы дают 95% точность — планирую на год вперед."
  },
  {
