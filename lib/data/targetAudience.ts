...
export const targetAudience: TargetAudience[] = [
  { 
    ...
    customerJourney: "Получает еженедельные сводки по всем типам рисков компании. Использует AI-аналитику для стратегического планирования и принятия решений на уровне совета директоров.",
  ...
  { 
    ...
    customerJourney: "Отслеживает правовые риски в документах и процессах. AI анализирует контракты и выявляет потенциальные юридические проблемы до их возникновения.",
  ...
  { 
    ...
    customerJourney: "Мониторит киберриски и уязвимости в IT-инфраструктуре. AI предсказывает возможные атаки и автоматически создает планы по укреплению безопасности.",
